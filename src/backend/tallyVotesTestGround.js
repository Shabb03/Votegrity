...
function primeFactorization(number, primes) {
    console.log("number, primes", number, primes);
    let primeCounts = {};
    var counter = 0
...
async function test() {
    ...
    if (votes.length > 1) {
        for (let i = 1; i < votes.length; i++) {
            ...
            console.log("initialDecryptedVoteCount", initialDecryptedVoteCount);
        }
    }
...
async function main() {
    ...
    console.log("primeFactorization", primeFactorization(decryptedvoteAsInt, primes))
}
